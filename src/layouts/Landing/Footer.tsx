        ...
        <div className={`${isMobile? "flex-col" : "flex-col"}
            ...
            <section className="h-full w-full flex flex-col items-center justify-start p-[calc(0.4vw+0.6rem)]">
                ...
                <div className={`${isMobile? "flex-col items-center gap-[calc(0.4vw+0.6rem)]" : "flex-row items-center"}
                    h-auto w-full flex justify-center p-[calc(0.4vw+0.6rem)] border-b border-[var(--border-color)]`}>
                    ...
                    <div className="flex-3 h-full flex flex-col items-start justify-center h-full gap-[calc(0.4vw+0.6rem)]">
                        
                        <div className="flex-1 w-full flex flex-col items-start justify-center p-[calc(0.4vw+0.6rem)]">
                            <span className="text-[calc(0.6vw+0.8rem)] cursor-pointer font-semibold hovered">Subscribe to our newsletter</span>
                            <div className="w-full flex flex-row items-center justify-center p-[calc(0.4vw+0.6rem)] pl-0">
                                <input type="email" placeholder="Enter your email"
                                    className={`${isDark? "border-[var(--light-color)]" : "border-[var(--dark-color)]"}
                        ...
                        <div className={`${isMobile? "pb-[calc(0.4vw+0.6rem)]" : "p-[calc(0.4vw+0.6rem)]"}
                            ...
                            <div className={`h-auto flex-1 flex flex-col items-start justify-center gap-[calc(0.4vw+0.6rem)]`}>
                                <span className="text-[calc(0.6vw+0.8rem)] font-semibold cursor-pointer hovered">About Us</span>
                                <span className="text-[calc(0.4vw+0.6rem)] cursor-pointer hovered">Mission</span>
                                <span className="text-[calc(0.4vw+0.6rem)] cursor-pointer hovered">Team</span>
                            ...
                            <div className="h-auto flex-1 flex flex-col items-start justify-center gap-[calc(0.4vw+0.6rem)]">
                                ...
                                <span className="text-[calc(0.4vw+0.6rem)] cursor-pointer hovered">Contact</span>
                                <span className="text-[calc(0.4vw+0.6rem)] cursor-pointer hovered">Support</span>
                                <span className="text-[calc(0.4vw+0.6rem)] cursor-pointer hovered">FAQ's</span>
                            </div>
                            <div className="h-auto flex-1 flex flex-col items-start justify-center gap-[calc(0.4vw+0.6rem)]">
